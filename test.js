...
tape('electron-shortcut-normalizer', function (test) {
  ...
  eq(n('Cmd+K', {platform: 'darwin'}), 'Command+K', 'accepts target `platform` in an options object')
  ...
  eq(n('Option+Tab+K', {platform: 'darwin', asSymbols: true}), '⎇+⇥+K', '(symbols) accepts target `platform` in an options object')
  test.end()
})
